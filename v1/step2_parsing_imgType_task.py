...
def img_convert_binary(img_path):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Analysis img convert to text for current pipline  Reduce 25% space usage")
    ...
    parser.add_argument("--processes_number", default=20, type=int, help="max processes")
